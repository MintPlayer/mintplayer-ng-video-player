        ...
        controller.addListener('ready', () => {
          ...
          if (!isReady) {
            ...
            adapter = createPlayerAdapter({
              ...
              getPlaybackRate: () => new Promise((resolve, reject) => reject('Spotify doesn\'t support changing playback rate')),
              setPlaybackRate: () => { throw 'Spotify doesn\'t support changing playback rate' },
              getPlaybackRates: () => new Promise((resolve, reject) => reject('Spotify doesn\'t support changing playback rate')),
              getQuality: () => new Promise((resolve, reject) => reject('Spotify doesn\'t support changing video quality')),
              setQuality: () => { throw 'Spotify doesn\'t support changing video quality' },
              getQualities: () => new Promise((resolve, reject) => reject('Spotify doesn\'t support changing video quality')),
